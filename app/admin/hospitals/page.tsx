...
export default function HospitalsPage() {
    ...
    const cities = ['all', ...Array.from(new Set(allHospitals.map(h => h.location?.city).filter(Boolean)))];

    // Filter hospitals by location filter
    const hospitals = locationFilter === 'all'
        ? allHospitals
        : allHospitals.filter(h => h.location?.city === locationFilter);
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Select value={locationFilter} onValueChange={setLocationFilter}>
                        <SelectTrigger className="w-[200px] border-2 border-black dark:border-white bg-white dark:bg-black">
