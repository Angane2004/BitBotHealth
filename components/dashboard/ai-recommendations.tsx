    ...
    return (
        <Card className="border-2 bg-white dark:bg-gray-900">
            <CardHeader>
                ...
                <CardDescription className="text-gray-600 dark:text-gray-400">
                    Smart insights based on real-time AQI, weather, festivals, and hospital capacity
                </CardDescription>
            </CardHeader>
                ...
                <AnimatePresence mode="popLayout">
                    {recommendations.map((rec) => (
                        <motion.div
                            ...
                            className="p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-shadow"
                        >
                            {/* Header */}
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                ...
                                {rec.basedOn.festival && (
                                    <Badge variant="outline" className="text-xs border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">
                                        📅 {rec.basedOn.festival}
                                    </Badge>
                                )}
                                {rec.basedOn.capacity && (
                                    <Badge variant="outline" className="text-xs border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">
                                        Capacity: {rec.basedOn.capacity}%
                                    </Badge>
                                )}
                                {rec.basedOn.weather && (
                                    <Badge variant="outline" className="text-xs border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">
                                        🌡️ {rec.basedOn.weather}
                                    </Badge>
                                )}
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    >
                                        ...
                                        {processing === rec.id ? 'Processing...' : 'Approve & Schedule'}
                                    </Button>
                                </div>
                            </div>
                        </motion.div>
